  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 4
      h1 Inseminación artificial en especies animales

    p.mb-5 La inseminación artificial (IA) es el proceso de recolectar espermatozoides de un animal macho y depositarlos manualmente en el tracto reproductivo de una hembra. La inseminación artificial se usa comúnmente en lugar del apareamiento natural, debido a los beneficios que se pueden obtener. Estos beneficios incluyen mayor seguridad en los animales y el productor, más eficiencia de producción y mejor genética.   

    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10
        .img-fnd-flot3.mb-3
          img.b-img3(src='@/assets/curso/temas/tema4/img-1.png' alt='Background Image')
          .fl-box3
    ...
    ImagenInfografica.color-acento-botones.mb-5
      ...
      .tarjeta.color-acento-botones.fnd-4.p-3(x="21%" y="35%" numero="1")
        .h5.mb-2 Tanque de almacenamiento
        p Es un tanque criogénico de nitrógeno líquido, su tamaño depende de la cantidad de pajillas que se necesiten almacenar. 	 

      .tarjeta.color-acento-botones.fnd-4.p-3(x="6.5%" y="65%" numero="2")
        .h5.mb-2 Pajillas y tijeras o corta pajillas
        p Las pajillas contienen el semen y puede ser de 0.25 – 0.5 cc y el corta pajillas se utiliza para un corte adecuado a la pajilla.	 

      .tarjeta.color-acento-botones.fnd-4.p-3(x="17.8%" y="79.5%" numero="3")
        .h5.mb-2 Toallas de papel
        p Cumplen funciones de protección de la pajilla después de retirar del tanque y para limpiar la vulva del animal.	 

      .tarjeta.color-acento-botones.fnd-4.p-3(x="34.7%" y="75.8%" numero="4")
        .h5.mb-2 Pistola de inseminación artificial	 
        p Se utiliza para poder introducir directamente en el punto blanco de la hembra.	 

      .tarjeta.color-acento-botones.fnd-4.p-3(x="41.5%" y="32.4%" numero="5")
        .h5.mb-2 Pinzas para la  manipulación de la pajilla
        p Necesarias para no tener quemaduras al momento de retirar del tanque de nitrógeno.	 

      .tarjeta.color-acento-botones.fnd-4.p-3(x="70.6%" y="73%" numero="6")
        .h5.mb-2 Recipientes para descongelado
        p Este recipiente se utiliza para descongelar la pajilla, cuenta con un termómetro.	 

      .tarjeta.color-acento-botones.fnd-4.p-3(x="83.4%" y="37.2%" numero="7")
        .h5.mb-2 Guantes de palpación desechables
        p Necesarios para tener BPM y para evitar cualquier enfermedad zoonótica.	 

      .tarjeta.color-acento-botones.fnd-4.p-3(x="70.6%" y="26.1%" numero="8")
        .h5.mb-2 Lubricante
        p Se utiliza para no causar dolencias o daño en el animal al momento de introducir la mano vía rectal.	 

      .tarjeta.color-acento-botones.fnd-4.p-3(x="59.6%" y="53%" numero="9")
        .h5.mb-2 Fundas sanitarias y fundas protectoras	
        p Utilizadas para no introducir ningún patógeno en la parte interior del aparato reproductor de la hembra.	 
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-8 
        ...
        p Los pasos para una inseminación en la hembra bovina se determinan con la elección de la hembra, para ello se requiere que se efectúen los siguientes pasos que se presentan en el siguiente recurso: 
      .col-lg-4
        figure.mb-5
    ...
    p Para concluir se puede decir que la inseminación artificial ha tenido una gran importancia en el mejoramiento genético de los animales, especialmente en el ganado bovino, donde su práctica es un requisito indispensable para los altos requerimientos de producción en un corto período de tiempo.     
